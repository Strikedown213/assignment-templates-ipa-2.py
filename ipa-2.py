...
def shift_letter_1(letter, shift):
    '''Shift Letter.
    5 points.
...
shifted_letter = shift_letter_1('X',5)
print("Shift letter: ", shifted_letter)
...
def caesar_cipher(message, shift):
    ...
    for letter in message:
        letter = shift_letter_1(letter,shift)
        new_message += letter
    return new_message
caesar = caesar_cipher("MESSAGE", 1)
...
shifts = shift_by_letter('B','C')
print("Shift by letter: ", shifts)
...
def vigenere_cipher(message, key):
    ...
    return adjmessage
vcipher = vigenere_cipher("LONGTEXT","KEY")
print("Vigenere Cipher: ", vcipher)
...
def scytale_cipher(message, shift):
    ...
    return messagetext
adjmessage = scytale_cipher("INFORMATION_AGE", 3)
print("Scytale Cipher: ", adjmessage)
...
def scytale_decipher(message, shift):
    ...
    for i in range(0, messagelength):
        ...
        messagetext += newmessage
    return messagetext
adjmessage = scytale_decipher("IMNNA_FTAOIGROE", 3)
print("Scytale Decipher: ", adjmessage)
